...
create or replace function public.complete_sale(p_items jsonb, p_payment_method text, p_customer_phone text default null, p_discount_paise bigint default 0)
...
revoke all on function public.complete_sale(jsonb, text, text, bigint) from public;
grant execute on function public.complete_sale(jsonb, text, text, bigint) to authenticated;
